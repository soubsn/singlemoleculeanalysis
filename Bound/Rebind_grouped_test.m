...
ylabel('Average')
title('Rebinding Events Spot Filtered All Activations')
a5=get(gca,'Xtick');
A5=a5(1,end-3);
a6=get(gca,'Ytick');
A6=a6(1,end-1);
...
savefig = Fileist(1).folder + "/Rebind_Events_Spot_Filtered_All_Activations.pdf";
saveas(gcf,savefig)
figure
